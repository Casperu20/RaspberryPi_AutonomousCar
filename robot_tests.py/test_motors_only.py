...
# Pins: (Input 1, Input 2, PWM)
# Re-assigned FL to GPIO 12, RL to GPIO 18 so they don't share clock conflicts
FL_PINS = (17, 27, 12)  
FR_PINS = (22, 23, 13)
RL_PINS = (25, 24, 18)  
RR_PINS = (6, 5, 19)

# Adjust these (1 or -1) after your first test flight to match physical wiring
MOTOR_FL_DIR = 1
MOTOR_FR_DIR = -1
MOTOR_RL_DIR = 1
MOTOR_RR_DIR = -1
...
def set_motor(pins, pwm, direction, speed, dir_multiplier):
    ...
    # Calculate target direction based on physical orientation multiplier
...
try:
    ...
    print("Motor test finished successfully!")
